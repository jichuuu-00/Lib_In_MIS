...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='BookAuthor',
            fields=[
                ('book_code', models.OneToOneField(db_column='Book_code', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='book.book')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Rental',
            fields=[
                ('mem_code', models.OneToOneField(db_column='Mem_code', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='book.member')),
